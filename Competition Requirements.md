...
11. Have an on-site registration process during which competitor data is validated.
   1. Competitors must be asked to validate the name, date of birth and citizenship they registered with.
   2. Especially new competitors (registered without existing WCA ID) should be asked: 
      1. to bring an ID document or a copy/picture of one to the competition for validating name, date of birth and citizenship.
      2. if they really never competed before in a WCA competition.
...
2. Location(s)
   ...
   5. 3x3x3 Fewest Moves simultaneous competitions
      ...
      2. Every location must clearly state who is the WCA Delegate for the venue.
            1. A Trainee Delegate cannot delegate a venue on their own.
...
5. Competitor limit
   1. The competitor limit can be on either a "first come first served" basis or based upon qualification results or rankings in the WCA world rankings of a previously announced calendar date.
      1. Qualification for an event must be based only on results from the same event.
        ...
        2. Exception: Any success in a Blind-event may be used as a qualification result for other blind events. 
   ...
   2. If the competitor limit for a competition or an event is reached before the competition, the organization team must not approve any additional registrations for the competition or the event.
       1. If on-site registration was enabled and registration closed with a reached limit, on-site registrations must not be accepted.
   ...
   6. For certain timeframes approved by the WCA Board (e.g. Newcomer Month), up to 50% of the maximum competitor limit may be reserved for competitors who have not competed in a WCA recognized competition before.
        1. If the spots reserved for first-time competitors do not fill before the last week of the registration period, the remaining spots must be available to all competitors who have completed the registration process.
6. Registration requirements
   1. The registration requirements are the set of rules and procedures relevant to the registration process.
      ...
      5. Any deadline must not be waived, unless it has been specified as a discretionary deadline.
         1. For discretionary deadlines: Once the first person requesting an exception is rejected, no further people must be granted the exception.
   ...
   4. The registration requirements must include the deadline for adding registered events for competitors with completed registrations.
      ...
      4. At the discretion of the WCA Delegate(s), a competitor who is deemed to have made a mistake during the registration process (e.g. registering for the inverse list of events that they intended) an exception can be made to the deadline for adding registered events.
   5. The registration requirements may include the conditions of the waiting list if one is to be used. Competitions are expected to use a waiting list unless specified by the organization team.
      ...
      2. It must be stated what the deadline is to be accepted for a registrant on the waiting list.
         ...
         2. This deadline should be the same as the deadline for refunds for competitors canceling their registration, if (partial) refunds are to be given.
